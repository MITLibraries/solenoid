    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retry_of', models.ForeignKey(blank=True, null=True, help_text='If this call is a retry of a previous failed call, this isa ForeignKey to that call. Otherwise it is blank.', to='elements.ElementsAPICall')),
            ],
        ),
    ]
