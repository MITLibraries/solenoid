...
class RecordModelTest(TestCase):
    ...
    def test_get_or_create_from_data(self):
        ...
        record, created = Record.get_or_create_from_data(author, {Fields.PAPER_ID: 1})
        assert record.pk == 1
        assert not created
    ...
    def test_get_duplicates_2(self):
        ...
        metadata = {
            ...
            Fields.ACQ_METHOD: "RECRUIT_FROM_AUTHOR_FPV",
            Fields.CITATION: (
                "Fermi, Enrico. Paper name. Some journal or " "other. 145:5 (2016)"
            ),
    ...
    def test_get_duplicates_3(self):
        ...
        metadata = {
            ...
            Fields.ACQ_METHOD: "RECRUIT_FROM_AUTHOR_FPV",
            Fields.CITATION: (
                "Tonegawa, Susumu. Paper name. Some journal or " "other. 31:4 (2012)"
            ),
    ...
    def test_create_citation_case_1(self):
        ...
        data.update(dict.fromkeys([Fields.VOLUME, Fields.ISSUE, Fields.DOI], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. (1973). Ultraviolet behavior "
    ...
    def test_create_citation_case_2(self):
        ...
        doi: NO"""
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.DOI], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. (1973). Ultraviolet behavior "
    ...
    def test_create_citation_case_3(self):
        ...
        doi: YES"""
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.VOLUME, Fields.ISSUE], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. (1973). Ultraviolet behavior "
    ...
    def test_create_citation_case_5(self):
        ...
        data = copy.copy(self.citation_data)
        data.update(
            dict.fromkeys([Fields.PUBDATE, Fields.VOLUME, Fields.ISSUE, Fields.DOI], None)
        )
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
    ...
    def test_create_citation_case_6(self):
        ...
        doi: NO"""
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.PUBDATE, Fields.DOI], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
    ...
    def test_create_citation_case_7(self):
        ...
        doi: YES"""
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.PUBDATE, Fields.VOLUME, Fields.ISSUE], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
    ...
    def test_create_citation_case_8(self):
        ...
        doi: YES"""
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.PUBDATE], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
    ...
    def test_create_citation_error_case_1(self):
        ...
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.PUBDATE, Fields.ISSUE, Fields.DOI], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
    ...
    def test_create_citation_error_case_2(self):
        ...
        data = copy.copy(self.citation_data)
        data.update(dict.fromkeys([Fields.PUBDATE, Fields.VOLUME, Fields.DOI], None))
        citation = Record.create_citation(data)
        self.assertEqual(
            citation,
            "Wilczek, F. Ultraviolet behavior of "
